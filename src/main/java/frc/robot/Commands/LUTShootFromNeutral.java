...
public class LUTShootFromNeutral extends Command {
     ...
     * @param shooter
     */
    public LUTShootFromNeutral( ShooterSubsystem shooter, FeederSubsystem feeder)
    {
    ...
    public void execute() {
        ...
        targetRPS = Constants.ShooterConstants.SHOOTER_MAP.get(3.0);
